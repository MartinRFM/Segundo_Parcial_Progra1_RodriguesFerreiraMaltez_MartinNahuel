...
class FormEnterName(Form):
    ...
    def __init__(self,name:str,pantalla:object,x:int,y:int,active:bool,level_num:int,music_name:str,score:int)->None:
        ...
        self.subtitle = TextTitle(x=DIMENSION_PANTALLA[0]//2,y=DIMENSION_PANTALLA[1]//2-90,texto="INGRESA TU NOMBRE:",pantalla=pantalla,font_size=50)
        ...
        self.button_confirm_name = Button(x=DIMENSION_PANTALLA[0]//2,y=DIMENSION_PANTALLA[1]//2+100,texto="CONFIRMA TU NOMBRE",pantalla=pantalla
